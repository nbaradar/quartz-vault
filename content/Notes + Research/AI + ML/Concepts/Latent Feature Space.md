...
Several embedding models have been developed to perform this transformation to create latent space embeddings given a set of data items and a [similarity function](https://en.wikipedia.org/wiki/Similarity_function "Similarity function"). These models learn the embeddings by leveraging statistical techniques and machine learning algorithms
- Word2Vec
- GloVe
- Siamese Networks
- Variational Autoencoders

![[Pasted image 20250620161546.png]]