...
![[Pasted image 20251210194223.png|350]]wa
# Industry 
## [OpenAI Exposes User Data in Security Leak](https://openai.com/index/mixpanel-incident/)
> - [Mixpanel](https://en.wikipedia.org/wiki/Mixpanel#:~:text=Mixpanel%20is%20an%20event%20analytics,Tim%20Trefren) is a data analytics provider that OpenAI used for web analytics on the frontend interface for the API product ([platform.openai.com](http://platform.openai.com/)), involved limited analytics data related to users API accounts.
...
![[Pasted image 20251127095403.png|400]]
## [Commitments on model deprecation and preservation](https://www.anthropic.com/research/deprecation-commitments)
> - Anthropic has found that when deprecating a model, the model will begin to [act misaligned to prevent retirement](https://www.anthropic.com/research/agentic-misalignment)
...
![[Pasted image 20251123174250.png|400]]
# Society
## [AI pioneer calls for UK to 'be brave' in tech race](https://www.bbc.com/news/articles/cy7e7mj0jmro)
...
![[Pasted image 20251123183836.png|400]]
## [Tech giants offering premium AI tools to millions of Indians for free](https://www.bbc.com/news/articles/c14pr0enjr6o)
...
![[Pasted image 20251115144259.png|400]]